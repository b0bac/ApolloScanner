...
SIMPLEUI_CONFIG = {
    ...
    'menu_display': ['资产扫描管理', 'Github信息收集', '暴力破解验证', '漏洞扫描验证', 'Nuclei扫描验证', '漏洞监控预警', '系统配置管理'],
    ...
    'menus': [
        ...
        },
        {
            ...
            'models': [
                {
                    'name': '负载管理',
                    'url': 'NucleiScan/nucleipocregister',
                    'icon': 'fa fa-bolt'
                },
                {
                    'name': '扫描任务',
                    'url': 'NucleiScan/nucleiscantasks',
                    'icon': 'fa fa-tasks'
                },
                {
                    'name': '扫描结果',
                    'url': 'NucleiScan/nucleiscanresult',
                    'icon': 'fa fa-server'
                },
            ]
        },
