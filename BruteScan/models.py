...
class BruteRegister(models.Model):
    ...
    function_name = models.CharField(max_length=100, db_column="function_name", verbose_name='函数名称', default="")
    code = models.TextField(db_column="code", null=True, verbose_name="负载代码")
